...
const AllocatedHistory = ({ auth }) => {
    ...
    const downloadExcel = async () => {
        const columnDefs = [
            ...
            {
                header: "Asset RFID", key: "RFIDnumber",
            ...
            },
            {
                ...
                header: "Employee Name", key: "FirstName",

            },
            {
                header: "Allocated by", key: "Createdby",

            },
            {
                header: "Allocated Date", key: "Createddate",

            },
        ];
        const rowData = gridRef.current.api.getRenderedNodes().map(n => n.data);
        const workbook = new ExcelJS.Workbook();
        const sheet = workbook.addWorksheet("Allocated History Report");
        // TURN OFF GRIDLINES
        ...
        titleCell.value = `ALLOCATED HISTORY REPORT - ${formattedDate}`;
        ...
        saveAs(new Blob([buffer]), "Allocated History Report.xlsx");
    };
    ...
    const handlepdf = async (selectedDate) => {
        ...
        const title = 'Allocated History Report';
        ...
        // ✅ Header columns
        const headers = [
            'S.No', 'Movement', 'Asset ID', 'Asset Name', 'Asset Type', 'Asset RFID', 'Employee ID', 'Employee RFID', 'Employee Name', 'Allocated by', 'Allocated Date'
        ];
        ...
        if (bodyData.length > 0) {
            ...
            doc.save("Allocated History Report.pdf");
        } else {
    ...
    const fetchdata = async () => {
        try {
            const alldata = { departmentname: auth.departmentname, mode: 'AllocatedReport', branchid: auth.branchid, BranchAccess: auth.BranchAccess }
    ...
    const columndef = [
        ...
        { headerName: "Movement", headerClass: 'agheader', field: "Movement", filter: true, floatingFilter: true },
        ...
        { headerName: "Asset RFID", headerClass: 'agheader', field: "RFIDnumber", filter: true, floatingFilter: true },
        ...
        { headerName: "Employee Name", headerClass: 'agheader', field: "FirstName", filter: true, floatingFilter: true },
        { headerName: "Allocated By", headerClass: 'agheader', field: "Createdby", filter: true, floatingFilter: true },
        {
            headerName: "Allocated Date", headerClass: 'agheader', field: "Createddate", filter: true, floatingFilter: true,
            valueGetter: (params) => {
            ...
            <Card className="mx-auto mt-2" id='box-shadow' style={{ maxWidth: "700px" }}>
                <CardHeader className="p-1 pro-header">
                    <div className='d-flex justify-content-center mt-1'>
                        ...
                        <h3 className="text-white ">Allocated History Report</h3>
                    </div>
                </CardHeader>
