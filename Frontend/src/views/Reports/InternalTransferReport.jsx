...
const InternalTransferReport = ({ auth }) => {
    ...
    const downloadExcel = async () => {
        const columnDefs = [
            ...
            { header: "Old Location", key: "Location" },
            { header: "New Location", key: "NewLocation" },
            { header: "Transfered By", key: "TransferedBy" },
            { header: "Remarks", key: "Remarks" },
            { header: "Transferred Date", key: "CreatedDate" },
        ];
        const rowData = gridRef.current.api.getRenderedNodes().map(n => n.data);
        const workbook = new ExcelJS.Workbook();
        const sheet = workbook.addWorksheet("Internal Transfer Report");
        // TURN OFF GRIDLINES
        ...
        titleCell.value = `INTERNAL TRANSFER REPORT - ${formattedDate}`;
        ...
        saveAs(new Blob([buffer]), "Internal Transfer Report.xlsx");
    };
    ...
    const handlepdf = async (selectedDate) => {
        ...
        const title = 'Internal Transfer Report';
        ...
        // ✅ Header columns
        const headers = [
            'S.No', 'RFID Number', 'Asset ID', 'Asset Name', 'Old Location', 'New Location', 'Transfered By', 'Remarks', 'Transferred Date'
        ...
        if (bodyData.length > 0) {
            ...
            doc.save("Internal Transfer Report.pdf");
        } else {
    ...
    const columndef = [
        ...
        { headerName: "Old Location", headerClass: 'agheader', field: "Location", filter: true, floatingFilter: true 
             ,valueGetter: (params) => {
                const value = params.data?.Location;
                return value || "-";
            }
        },
        { headerName: "New Location", headerClass: 'agheader', field: "NewLocation", filter: true, floatingFilter: true 
             ,valueGetter: (params) => {
                const value = params.data?.NewLocation;
                return value || "-";
            }
        },
        { headerName: "Transfered By", headerClass: 'agheader', field: "TransferedBy", filter: true, floatingFilter: true 
             ,valueGetter: (params) => {
                const value = params.data?.TransferedBy;
                return value || "-";
            }
        },
        { headerName: "Remarks", headerClass: 'agheader', field: "Remarks", filter: true, floatingFilter: true 
             ,valueGetter: (params) => {
                const value = params.data?.Remarks;
                return value || "-";
            }
        },
        {
    ...
    return (
        <div className=''>
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header p-2 pro-header">
                            <h1 className="modal-title text-white fs-5" id="exampleModalLabel">Download Format</h1>
            ...
            {/* <h3 className=" text-center m-0">Internal Transfer Report</h3> */}
            <Card className="mx-auto mt-2" id='box-shadow' style={{ maxWidth: "700px" }}>
                <CardHeader className="p-2 pro-header">
                    <h3 className="text-white text-center m-0">Internal Transfer Report</h3>
                </CardHeader>
                <CardBody>
...
InternalTransferReport.propTypes = {
