...
const MaintenanceReport = ({ auth }) => {
  ...
  // const downloadExcel = () => {
  //   const params = {
  //     fileName: 'UnderMaintenance.csv',
  //     columnKeys: ['RFIDnumber', 'AssetID', 'AssetName', 'Vendors', 'MaintenanceType', 'CreatedDate', 'Description']
  //   };
  ...
  const downloadExcel = async () => {
    const columnDefs = [
      ...
      {
        header: "Registered By", key: "CreatedBy",
      },
      {
        header: "Maintenance RegDate", key: "CreatedDate",
      },
      { header: "Description", key: "Description" },
    ];
    const rowData = gridRef.current.api.getRenderedNodes().map(n => n.data);
    const workbook = new ExcelJS.Workbook();
    const sheet = workbook.addWorksheet("Under-Maintenance Report");
    // TURN OFF GRIDLINES
    ...
    titleCell.value = `UNDER-MAINTENANCE REPORT - ${formattedDate}`;
    ...
    saveAs(new Blob([buffer]), "Under-Maintenance Report.xlsx");
  };
  //pdf
  const handlepdf = async (selectedDate) => {
    ...
    const title = 'Under-Maintenance Report';
    ...
    // ✅ Header columns
    const headers = [
      'S.No', 'RFID Number', 'Asset ID', 'Asset Name', 'Vendor', 'Maintenance Type', 'Registered By', 'Maintenance Reg Date', 'Status', 'Description'
    ...
    if (bodyData.length > 0) {
      ...
      doc.save("Under-Maintenance Report.pdf");
    } else {
  ...
  const columndef = [
    ...
    {
      headerName: "Vendor", headerClass: 'agheader', field: "VendorName", filter: true, floatingFilter: true
      , valueGetter: (params) => {
    ...
    {
      headerName: "Maintenance Type", headerClass: 'agheader', field: "MaintenanceType", filter: true, floatingFilter: true
      , valueGetter: (params) => {
        const value = params.data?.MaintenanceType;
        return value || "-";
      }
    },
    {
      headerName: "Registered By", headerClass: 'agheader', field: "CreatedBy", filter: true, floatingFilter: true
      , valueGetter: (params) => {
    ...
    {
      headerName: "Maintenance Reg Date", headerClass: 'agheader', field: "CreatedDate",
      valueGetter: (params) => {
  ...
  return (
    <div className=''>
      ...
      <Card className="mx-auto mt-2" id='box-shadow' style={{ maxWidth: "700px" }}>
        <CardHeader className="p-1 pro-header">
          <div className='d-flex justify-content-center mt-1'>
            ...
            <h3 className="text-white ">Under-Maintenance Report</h3>
          </div>
        </CardHeader>
      ...
      <div className='card shadow mt-1'>
        <div className='ag-theme-quartz' style={{ height: "460px" }}>
      ...
      {/* <div className="">
        <small ref={componentRef} >
          <div className="col-lg-8">
            <table
              className="table table-bordered"
              style={{
                width: '99%', borderCollapse: 'collapse',
                border: '1px black solid', fontSize: "12px"
              }}
            >
              <tbody>
                <tr>
                  <td colSpan="6" style={{ verticalAlign: 'middle' }}>
                    <div >
                      <h2 style={{ fontSize: "20px", fontWeight: 'bold', textAlign: 'center' }} >DELIVERY CHALLAN</h2>
                      <div style={{ textAlign: 'right' }}>
                        FM/STR/01<br />
                        Issue Date: 01/09/12<br />
                        Rev No.00
                      </div>
                    </div>
                    <div>
                ...
                <tr>
                  <td colSpan="3" style={{ width: '50%' }}>
                    ARO-SAK PLASTICS & ASSEMBLIES P LTD <br />
                    No 29/1/A1, 1/227, Multi Industrial Nagar, <br />
                    Gerugambakkam, Chennai - 600 128. <br />
                    State: Tamil Nadu - Code 33 <br />
                    Phone: 9042055604 / Email: selvam.l@arosak.net
                  </td>
                  <td colSpan="3" style={{ width: '50%' }}>
                   <br />
                    <p style={{ wordBreak: 'break-word', margin: 0.2 }}> </p>
                    GSTIN: 
                  </td>
                </tr>
                <tr>
                  <td colSpan={2}>Please receive the following</td>
                  <td style={{ verticalAlign: 'middle', whiteSpace: 'nowrap' }}>WO No </td>
                  <td>WO Qty </td>
                  <td>Output Part No</td>
                  <td></td>
                </tr>
                ...
                <tr>
                  <td colSpan="4" style={{ fontWeight: '870', borderRight: 'none' }}>Receiver's Signature:</td>
                  <td className="text-end">Total:</td>
                </tr>

                <tr>
                  <td colSpan="3" style={{ borderRight: 'none', textAlign: 'center' }}>
                    <p ><strong>NOT FOR SALE<br /> FOR FURTHER PROCESS AND RETURN!!</strong></p>
                  </td>
                  <td colSpan="3" style={{ borderLeft: 'none', textAlign: 'center' }}>
                    <p className='mb-5'><strong>FOR ARO-SAK PLASTICS & ASSEMBLIES P LTD</strong></p>
