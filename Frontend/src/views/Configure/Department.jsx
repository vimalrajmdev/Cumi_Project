...
const IndustryType = ({ auth }) => {
    ...
    const fetchData = async () => {
        try {
            ...
            const response = await axios.post(`${API_URL}/FetchDepartment`, data);
    ...
    // Handle Save (Add New Department)
    const handleSave = async () => {
        ...
        const isDuplicate = rowdata.some(item =>
            item.Department?.toString().trim().toLowerCase() === Register.Department.trim().toLowerCase()
        );
    ...
    const handlefetch = async (DepartmentID) => {
        ...
        try {
            ...
            const payload = { DepartmentID, mode: 'SI', branchid: auth.branchid };
            const response = await axios.post(`${API_URL}/FetchGivenDataDepartment`, payload);

            if (response.status === 200 && response.data.send.length > 0) {
                const deptData = response.data.send[0];
                setRegister(deptData);
                setoldRegister({ oldDepartment: deptData.Department });
            }
        } catch (err) {
            console.error(err);
        }
    ...
    const handleEdit = async () => {
        ...
        const isDuplicate = rowdata.some(item =>
            item.DepartmentID !== Register.DepartmentID &&
            item.Department?.toString().trim().toLowerCase() === Register.Department.trim().toLowerCase()
        );
        ...
        try {
            const payload = { ...Register, ...oldRegister, mode: 'U', Updatedby: auth.empid, branchid: auth.branchid };
            const response = await axios.post(`${API_URL}/UpdateDepartment`, payload);
    ...
    const downloadExcel = async () => {
        ...
        titleCell.value = `DEPARTMENT MASTER - ${formattedDate}`;
        ...
        saveAs(new Blob([buffer]), "Department Master.xlsx");
    };
    ...
    const handlepdf = async () => {
        ...
        const headers = ['S.No', 'Department', 'Created By', 'Created Date', 'Last Modified By', 'Last Modified Date'];
        ...
        if (bodyData.length > 0) {
            ...
            doc.save("Department Master.pdf");
        } else {
    ...
    const handleUploadData = async () => {
        ...
        const confirm = await Swal.fire({
            ...
            text: "This will import department data.",
            icon: "question",
        ...
        try {
            ...
            const response = await axios.post(`${API_URL}/DepartmentUploadData`, formData, {
            ...
            if (unuploadedFilePath) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        link.download = 'UnuploadedDepartment.xlsx';
                        link.click();
                    }
                });
            } else {
    ...
    const EditRenderer = (params) => {
        ...
        return (
            <button
                ...
                onClick={() => handlefetch(params.data.DepartmentID)}
                onMouseEnter={e => {
    ...
    const columndef = [
        ...
        { headerName: "Department", field: 'Department', filter: true, floatingFilter: true },
        ...
        <div>
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header p-2 pro-header">
                            <h1 className="modal-title fs-5 text-white">Add Department</h1>
                        ...
                        <div className="modal-body">
                            ...
                            <input
                                ...
                                onChange={(e) => setRegister({ ...Register, Department: e.target.value })}
                            />
            ...
            <div className="modal fade" id="exampleModalEdit" tabIndex="-1" data-bs-backdrop="static">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header p-2 pro-header">
                            <h1 className="modal-title fs-5 text-white">Edit Department</h1>
                            <button type="button" className="btn-close btn-close-white" data-bs-dismiss="modal" onClick={resetForm}></button>
                        </div>
                        <div className="modal-body">
                            <label className="form-label">Department Name <span className="text-danger">*</span></label>
                    ...
                    <div className="modal-dialog modal-dialog-centered modal-lg">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">Import Departments</h5>
                            ...
                            <div className="modal-body">
                                ...
                                <div className="text-center mt-3 text-danger small">
                                    ...
                                    <br />
                                    <a href="/DepartMentTemp.xlsx" download className="text-primary">Download Template</a>
                                </div>
                            </div>
                    ...
                    <div className="d-flex align-items-center">
                        ...
                        <div className="text-center" style={{ width: "34%" }}>
                            <h3 className="text-white m-0">
                                <BsFillDiagram3Fill className="fs-2 mb-2" /> Department Details
                            </h3>
                        </div>
