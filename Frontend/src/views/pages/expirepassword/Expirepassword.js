...
const Expirepassword = () => {
    ...
    const handleChangepassword = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${API_URL}/ExpirePasswordRest`, changepasswordData)
                        ...
                        <CCol md={9} lg={7} xl={6}>
                            <CCard className="mx-4">
                                <CCardBody className="p-4">
                                    ...
                                    <CForm className="m-5 content" >

                                        <p className="fw-bold text-center mt-3 text-primary">Password Expired</p>
